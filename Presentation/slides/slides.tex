...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{costModel}
    \caption{Partitioning skew example}\label{img:costModel}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{fineP}
    \caption{Fine partitioning}\label{img:fineP}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{dynF}
    \caption{Dynamic fragmentation}\label{img:dynF}
\end{figure}
